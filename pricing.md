...
- Zawiera: wszystko z Plus + sufler MAIA na żywo (podpowiedź dla rejestratorki w trakcie rozmowy, niesłyszalna dla pacjenta), moduł „Skąd dzwonią" (telefon przypisany do kampanii, raport do umówionej wizyty z powodem odmowy, dane z Meta i Google), jedna skrzynka wiadomości (e-mail, SMS, WhatsApp, Messenger, Instagram — każdy kanał +39 zł), Kalendarz wizyt (kolumny per lekarz, luki na żywo), wypełnianie luk z propozycją pacjentów i SMS, automatyczne przypomnienia i potwierdzenia SMS, przedpłaty online (BLIK / szybki przelew / karta), karta pacjenta (CRM), plan leczenia jako sekwencja wizyt, zadania zespołu; 3 licencje + konto administratora gratis
